 ...
 */
public class SpatialHDFSReplicator extends BlockPlacementPolicyDefault {

    protected SpatialHDFSReplicator(Configuration conf, FSClusterStats stats,
                                    NetworkTopology clusterMap, DatanodeManager datanodeManager) {
        initialize(conf, stats, clusterMap, host2datanodeMap);
    }

    protected SpatialHDFSReplicator() {
    }
    ...
    private int addDependentNodesToExcludedNodes(DatanodeDescriptor chosenNode,
        ...
        LOG.warn("################################################################");
        LOG.warn("###################### addDependentNodesToExcludedNodes ########################");
        LOG.warn("################################################################");
